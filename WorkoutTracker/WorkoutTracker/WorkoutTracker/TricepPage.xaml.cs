...
namespace WorkoutTracker
{
    ...
    public partial class TricepPage : ContentPage
    {
        DataAccess dataAccess;
        String exerciseName = "tricep";
        ...
        protected override async void OnAppearing()
        {
            ...
            if (lifts.Count == 0)
            {
                List<Lift> tricepLifts = new List<Lift>();
                tricepLifts.Add(new Lift { ExerciseName = "Dumbbell Two Arm Overhead Extension", Muscle = exerciseName, Reps = 0, Weight = 0 });
                tricepLifts.Add(new Lift { ExerciseName = "Cable Two Arm Pull Down", Muscle = exerciseName, Reps = 0, Weight = 0 });
                tricepLifts.Add(new Lift { ExerciseName = "Dumbbell One Arm Overhead Extension", Muscle = exerciseName, Reps = 0, Weight = 0 });
                tricepLifts.Add(new Lift { ExerciseName = "Tricep Dip", Muscle = exerciseName, Reps = 0, Weight = 0 });
                foreach (Lift lift in tricepLifts)
                {
